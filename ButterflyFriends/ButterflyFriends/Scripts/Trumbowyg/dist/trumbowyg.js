            ...
            if (svgPathOption == null) {
                try {
                    ...
                    for (var i in stackLines) {
                        ...
                        svgPathOption = stackLines[Number(i)].match(/((http[s]?:\/\/.+\/)([^\/]+\.js))(\?.*)?:/)[1]
                            .split("/");
                        svgPathOption.pop();
    ...
    Trumbowyg.prototype = {
        ...
        buildEditor: function() {
            ...
            t.$ed
                ...
                .on("compositionstart compositionupdate",
                    function() {
                        composition = true;
                    })
                .on(updateEventName + " compositionend",
                    function(e) {
                ...
                .on("focus blur",
                    function(e) {
                        ...
                        if (e.type === "blur") {
                            $("." + prefix + "active-button", t.$btnPane)
                                .removeClass(prefix + "active-button " + prefix + "active");
                        }
                    })
                .on("cut",
                    function() {
                ...
                .on("paste",
                    function(e) {
                        ...
                        // Call pasteHandlers
                        $.each(t.pasteHandlers,
                            function(i, pasteHandler) {
                                pasteHandler(e);
                            });
            ...
            var t = this,
                ...
                $btn = $("<button/>",
                {
                    ...
                    mousedown: function() {
                        ...
                        t.execCmd((isDropdown ? "dropdown" : false) || btn.fn || btnName,
                            btn.param || btnName,
                            btn.forceCss || false);
        ...
        fixedBtnPaneEvents: function() {
            ...
            $(window)
                .on("scroll." + t.eventNamespace + " resize." + t.eventNamespace,
                    function() {
                        if (!$box) {
                            return;
                        }
        ...
        syncTextarea: function() {
            var t = this;
            t.$ta.val(t.$ed.text().trim().length > 0 || t.$ed.find("hr, img, embed, iframe, input").length > 0
                ? t.$ed.html()
                : "");
        },
            ...
            if (t.o.semantic) {
                ...
                if (full) {
                    ...
                    var wrapInlinesInParagraphsFrom = function($from) {
                        if ($from.length !== 0) {
                            var $finalParagraph = $from.nextUntil(blockElementsSelector)
                                    .addBack()
                                    .wrapAll("<p/>")
                                    .parent(),
                    ...
                    t.$ed.find("p")
                        .filter(function() {
                            ...
                            return $(this).text().trim().length === 0 &&
                                $(this).children().not("br, span").length === 0;
                        })
                        .contents()
                        .unwrap();
        ...
        insertImage: function() {
            ...
            t.openModalInsert(t.lang.insertImage,
                ...
                function(v) { // v are values
                    ...
                    var img = $('img[src="' + v.url + '"]:not([alt])', t.$box).attr("alt", v.alt);
                    //img.css("max-width", "100%");
                    //img.attr("onload","imagescss(this)");
                    return true;
                });
        },
        fullscreen: function() {
