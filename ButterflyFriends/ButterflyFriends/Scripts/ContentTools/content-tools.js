...
(function() {
    ...
    HTMLString.String = (function() {
        ...
        String.prototype.concat = function() {
            var c,
                ...
                _ref,
                _ref1;
            strings = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []),
        ...
        String.prototype.hasTags = function() {
            ...
            tags = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []),
                strict = arguments[_i++];
        ...
        String.prototype.optimize = function() {
            ...
            for (_n = 0, _len5 = _ref3.length; _n < _len5; _n++) {
                ...
                _results.push(c.addTags.apply(c,
                (function() {
        ...
        String.prototype.split = function(separator, limit) {
            ...
            substrings = [];
            for (i = _i = 0, _ref = indexes.length - 2;
    ...
    _Parser = (function() {
        function _Parser() {
            ...
            this.fsm.addTransitionAny(CHAR_OR_ENTITY_OR_TAG,
                null,
                function(c) {
            ...
            this.fsm.addTransitions(ENTITY_CHARS,
                ENTITY,
                null,
                function(c) {
            ...
            this.fsm.addTransitions(ALPHA_CHARS,
                OPENNING_OR_CLOSING_TAG,
                OPENING_TAG,
                function() {
                    return this._back();
            ...
            this.fsm.addTransitions(TAG_NAME_CHARS,
                TAG_NAME_OPENING,
                null,
                function(c) {
            ...
            this.fsm.addTransitions(ATTR_NAME_CHARS,
                ATTR_NAME,
                null,
                function(c) {
            ...
            this.fsm.addTransitionAny(ATTR_NAME_FIND_VALUE,
                ATTR_OR_TAG_END,
                function() {
                    this._pushAttribute();
                    return this._back();
            ...
            this.fsm.addTransitions(ALPHA_NUMERIC_CHARS.concat(["&"],
                ATTR_DELIM,
                ATTR_VALUE_NO_DELIM,
                function() {
                    return this._back();
            ...
            this.fsm.addTransitionAny(ATTR_VALUE_NO_DELIM,
                null,
                function(c) {
            ...
            this.fsm.addTransitionAny(ATTR_VALUE_SINGLE_DELIM,
                null,
                function(c) {
                    return this.attributeValue += c;
                });
            ...
            this.fsm.addTransitionAny(ATTR_VALUE_DOUBLE_DELIM,
                null,
                function(c) {
                    return this.attributeValue += c;
                });
    ...
    HTMLString.Character = (function() {
        ...
        Character.prototype.copy = function() {
            var t;
            return new HTMLString.Character(this._c,
            (function() {
                var _i, _len, _ref, _results;
                _ref = this._tags;
                _results = [];
...
(function() {
    ...
    ContentSelect.Range = (function() {
        ...
        Range.query = function(element) {
            ...
            _ref = _getNodeRange(element, docRange), startNode = _ref[0], startOffset = _ref[1], endNode = _ref[2],
                endOffset = _ref[3];
            range.set(_getOffsetOfChildNode(element, startNode) + startOffset,
            ...
            case Node.ELEMENT_NODE:
                if (_ref = childNode.nodeName.toLowerCase(), __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref) >= 0) {
                    ...
                    if (childNode.childNodes) {
                        Array.prototype.unshift.apply(childStack,
                        (function() {
    ...
    _getOffsetOfChildNode = function(parentNode, childNode) {
        ...
        while (childStack.length > 0) {
            ...
            case Node.TEXT_NODE:
                ...
                break;
            case Node.ELEMENT_NODE:
                if (_ref1 = otherChildNode.nodeName
                    .toLowerCase(), __indexOf.call(SELF_CLOSING_NODE_NAMES, _ref1) >= 0) {
                    offset += 1;
                } else {
...
(function() {
    ...
    ContentEdit.Text = (function(_super) {
        ...
        Text.prototype._keyLeft = function(ev) {
            ...
            if (previous) {
                ...
                return ContentEdit.Root.get()
                    .trigger("previous-region",
                        this.closest(function(node) {
        ...
        Text.fromDOMElement = function(domElement) {
            return new this(domElement.tagName,
    ...
    ContentEdit.TagNames.get()
        .register(ContentEdit.Text, "address", "blockquote", "h1", "h2", "h3", "h4", "h5", "h6", "p");
    ...
    ContentEdit.PreText = (function(_super) {
        ...
        PreText.prototype._keyTab = function(ev) {
            ...
            if (startLine === endLine) {
                ...
                if (ev.shiftKey) {
                    firstLineShift = 0;
                    for (i = _j = startLine;
                        startLine <= endLine ? _j <= endLine : _j >= endLine;
                        i = startLine <= endLine ? ++_j : --_j) {
                    ...
                    for (i = _l = startLine;
                        startLine <= endLine ? _l <= endLine : _l >= endLine;
                        i = startLine <= endLine ? ++_l : --_l) {
            ...
            return new ContentSelect.Range(selection[0] + selectionOffset, selection[1] + selectionLength)
        ...
        PreText.prototype._syncContent = function(ev) {
            ...
            this._ensureEndZWS();
            snapshot = this.content.html();
            this.content = new HTMLString.String(this._domElement.innerHTML.replace(/\u200B$/g, ""),
    ...
    ContentEdit.TableCellText = (function(_super) {
        ...
        TableCellText.prototype._keyUp = function(ev) {
            ...
            if (this._isInFirstRow()) {
                ...
                previousRow = cell.parent()
                    .previousWithTest(function(node) {
                        return node.type() === "TableRow";
                    });
                cellIndex = cell.parent().children.indexOf(cell);
...
(function() {
    ...
    ContentTools = {
        ...
        DEFAULT_TOOLS: [
            ...
            [
                ...
                "line-break"
            ], ["image", "video", "preformatted"], ["undo", "redo", "remove"]
        ],
    ...
    ContentTools.FlashUI = (function(_super) {
        ...
        FlashUI.prototype.mount = function(modifier) {
            ...
            this._domElement = this.constructor.createDiv([
                "ct-flash", "ct-flash--active", "ct-flash--" + modifier, "ct-widget", "ct-widget--active"
            ]);
    ...
    ContentTools.IgnitionUI = (function(_super) {
        ...
        IgnitionUI.prototype._addDOMEventListeners = function() {
            this._domEdit.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
                    return _this.edit();
            ...
            this._domConfirm.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
            ...
            return this._domCancel.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
                    return _this.cancel();
    ...
    ContentTools.ModalUI = (function(_super) {
        ...
        ModalUI.prototype._addDOMEventListeners = function() {
            return this._domElement.addEventListener("click",
            (function(_this) {
                return function(ev) {
            ...
            for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
                ...
                _results.push((function() {
                    ...
                    for (_j = 0, _len1 = toolGroup.length; _j < _len1; _j++) {
                        ...
                        _results1.push(this._toolUIs[toolName].addEventListener("applied",
                        (function(_this) {
                            return function() {
    ...
    ContentTools.DialogUI = (function(_super) {
        ...
        DialogUI.prototype._addDOMEventListeners = function() {
            ...
            return this._domClose.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
                    if (_this._busy) {
    ...
    ContentTools.ImageDialog = (function(_super) {
        ...
        ImageDialog.prototype.mount = function() {
            ...
            this._domRotateCCW = this.constructor
                .createDiv(["ct-control", "ct-control--icon", "ct-control--rotate-ccw"]);
            ...
            this._domCancelUpload = this.constructor
                .createDiv(["ct-control", "ct-control--text", "ct-control--cancel"]);
        ...
        ImageDialog.prototype._addDOMEventListeners = function() {
            ...
            this._domCancelUpload.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    return _this.dispatchEvent(_this.createEvent("imageuploader.cancelupload"));
                };
            })(this));
            this._domClear.addEventListener("click",
            (function(_this) {
                return function(ev) {
            ...
            this._domRotateCCW.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    _this.removeCropMarks();
            ...
            this._domRotateCW.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    _this.removeCropMarks();
            ...
            this._domCrop.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    if (_this._cropMarks) {
            ...
            return this._domInsert.addEventListener("click",
            (function(_this) {
                return function(ev) {
    ...
    CropMarksUI = (function(_super) {
        ...
        CropMarksUI.prototype.mount = function(domParent, before) {
            ...
            this._domRulers = [
                this.constructor.createDiv(["ct-crop-marks__ruler", "ct-crop-marks__ruler--top-left"]), this.constructor
                .createDiv(["ct-crop-marks__ruler", "ct-crop-marks__ruler--bottom-right"])
            ];
            this._domClipper.appendChild(this._domRulers[0]);
            this._domClipper.appendChild(this._domRulers[1]);
            this._domHandles = [
                this.constructor.createDiv(["ct-crop-marks__handle", "ct-crop-marks__handle--top-left"]), this
                .constructor.createDiv(["ct-crop-marks__handle", "ct-crop-marks__handle--bottom-right"])
            ];
        ...
        CropMarksUI.prototype._addDOMEventListeners = function() {
            ...
            this._domHandles[0].addEventListener("mousedown",
            (function(_this) {
                return function(ev) {
                    if (ev.button === 0) {
            ...
            return this._domHandles[1].addEventListener("mousedown",
            (function(_this) {
                return function(ev) {
                    if (ev.button === 0) {
    ...
    ContentTools.LinkDialog = (function(_super) {
        ...
        LinkDialog.prototype._addDOMEventListeners = function() {
            this._domInput.addEventListener("keypress",
            (function(_this) {
                return function(ev) {
                    if (ev.keyCode === 13) {
                        return _this.save();
            ...
            this._domTargetButton.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
                    if (_this._target === NEW_WINDOW_TARGET) {
                        _this._target = "";
                        return ContentEdit.removeCSSClass(_this._domTargetButton,
                            "ct-anchored-dialog__target-button--active");
                    } else {
                        _this._target = NEW_WINDOW_TARGET;
                        return ContentEdit.addCSSClass(_this._domTargetButton,
                            "ct-anchored-dialog__target-button--active");
                    }
                };
            })(this));
            return this._domButton.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    ev.preventDefault();
                    return _this.save();
    ...
    ContentTools.PropertiesDialog = (function(_super) {
        ...
        PropertiesDialog.prototype.mount = function() {
            ...
            this._domAttributesTab = this.constructor
                .createDiv(["ct-control", "ct-control--icon", "ct-control--attributes"]);
            ...
            this._domRemoveAttribute = this.constructor
                .createDiv(["ct-control", "ct-control--icon", "ct-control--remove", "ct-control--muted"]);
        ...
        PropertiesDialog.prototype._addAttributeUI = function(name, value) {
            ...
            attributeUI.addEventListener("blur",
                function(ev) {
        ...
        PropertiesDialog.prototype._addDOMEventListeners = function() {
            ...
            return this._domApply.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    var cssClass;
                    ev.preventDefault();
    ...
    AttributeUI = (function(_super) {
        ...
        AttributeUI.prototype._addDOMEventListeners = function() {
            ...
            this._domName.addEventListener("keydown",
            (function(_this) {
                return function(ev) {
                    if (ev.keyCode === 13) {
            ...
            return this._domValue.addEventListener("keydown",
            (function(_this) {
                return function(ev) {
    ...
    ContentTools.TableDialog = (function(_super) {
        ...
        TableDialog.prototype.mount = function() {
            ...
            this._domBodySection = this.constructor
                .createDiv(["ct-section", "ct-section--applied", "ct-section--contains-input"]);
        ...
        TableDialog.prototype._addDOMEventListeners = function() {
            ...
            this._domBodySection.addEventListener("click",
            (function(_this) {
                return function(ev) {
                    return _this._domBodyInput.focus();
                };
            })(this));
            this._domBodyInput.addEventListener("input",
            (function(_this) {
                return function(ev) {
                    var valid;
    ...
    ContentTools.VideoDialog = (function(_super) {
        ...
        VideoDialog.prototype.mount = function() {
            ...
            this._domButton = this.constructor.createDiv([
                "ct-control", "ct-control--text", "ct-control--insert", "ct-control--muted"
            ]);
    ...
    _EditorApp = (function(_super) {
        ...
        _EditorApp.prototype.init = function(queryOrDOMElements, namingProp, fixtureTest, withIgnition) {
            ...
            if (withIgnition) {
                ...
                this._ignition.addEventListener("edit",
                (function(_this) {
                    return function(ev) {
                        ev.preventDefault();
                        _this.start();
                ...
                this._ignition.addEventListener("confirm",
                (function(_this) {
                    return function(ev) {
                        ev.preventDefault();
                ...
                this._ignition.addEventListener("cancel",
                (function(_this) {
                    return function(ev) {
                        ev.preventDefault();
                        if (_this._ignition.state() !== "editing") {
    ...
    ContentTools.Tools.Link = (function(_super) {
        ...
        Link.apply = function(element, selection, callback) {
            ...
            dialog = new ContentTools.LinkDialog(this.getAttr("href", element, selection),
    ...
    ContentTools.Tools.AlignLeft = (function(_super) {
        ...
        AlignLeft.apply = function(element, selection, callback) {
            ...
            alignmentClassNames = [
                ContentTools.Tools.AlignLeft.className, ContentTools.Tools.AlignCenter.className,
